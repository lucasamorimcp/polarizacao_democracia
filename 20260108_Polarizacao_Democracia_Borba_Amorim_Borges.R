...
modelos <- tibble(
  ...
  dv = c(
    rep("af_valores_liberal", 1),
    rep("af_valores_autoritario", 1),
    rep("af_valores_liberal", 1),
    rep("af_valores_autoritario", 1)
  ),
  espec = c(
...
ggsave(
  filename = "grafico_polarizacao_ideologica.png",
  width = 8,       
  height = 3,      
  dpi = 400,        
  units = "in"      
...
ggsave(
  filename = "grafico_polarizacao_afetiva.png",
  width = 8,       
  height = 3,      
  dpi = 400,        
  units = "in"      
...
ggsave(
  filename = "grafico_polarizacao_economica.png",
  width = 8,       
  height = 3,      
  dpi = 400,        
  units = "in"      
